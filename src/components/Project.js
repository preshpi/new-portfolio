  ...
  return (
    <div name='project'>   
      ...
      <div className="sm:grid grid-cols-2 px-4">
        <div className="image  max-w-sm rounded overflow-hidden shadow-lg m-5" >      
          ...
          <div className="content">
                ...
                <div className="flex">
                   <sm className="mx-2 mb-1 text-[#a3d4ff]">Check me out</sm>
                   <a href="https://preciousegwuenu.vercel.app/"><BsArrowUpRightSquareFill className="cursor-pointer"/></a>
              </div>
